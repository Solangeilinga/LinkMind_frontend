...
class AppTextStyles {
  ...
  static const button = TextStyle(
      fontSize: 15, fontWeight: FontWeight.w800, fontFamily: fontFamily);
}
  ...
  static ThemeData get light => ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          border: const OutlineInputBorder(
              borderRadius: AppRadius.md, borderSide: BorderSide.none),
  ...
  static ThemeData get dark => ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          hintStyle: AppTextStyles.body
              .copyWith(color: const Color(0xFFB0A0A0)), // Plus clair
        ...
        dividerTheme:
            const DividerThemeData(color: Color(0xFF4A2A2A), thickness: 1),
